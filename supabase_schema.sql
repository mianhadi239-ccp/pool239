...
CREATE TABLE IF NOT EXISTS public.pool_bookings (
    ...
    customer_email TEXT NOT NULL DEFAULT 'n/a',
...
-- If table already exists, alter to add customer_email column safely:
ALTER TABLE public.pool_bookings ADD COLUMN IF NOT EXISTS customer_email TEXT NOT NULL DEFAULT 'n/a';
...
-- RLS Policy 3: Allow full access (Update/Delete) for admin users
...
(invoice_number, customer_name, customer_email, booking_date, day_of_week, people, hours, rate_per_person_per_hour, total_price, status)
VALUES
('INV-7X9K-3A1B', 'John Doe', 'john.doe@example.com', '2026-07-23', 'Thursday', 4, 2, 300.00, 2400.00, 'accepted'),
('INV-8Y2M-9C4D', 'Sarah Smith', 'sarah.smith@example.com', '2026-07-25', 'Saturday', 6, 3, 300.00, 5400.00, 'accepted'),
('INV-9Z4P-1E5F', 'Mike Johnson', 'mike.j@example.com', '2026-07-28', 'Tuesday', 5, 2, 300.00, 3000.00, 'pending'),
('INV-1A5Q-6F7G', 'David Lee', 'david.lee@example.com', '2026-08-01', 'Saturday', 8, 4, 300.00, 9600.00, 'pending')
